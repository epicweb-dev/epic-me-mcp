/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./types/worker-configuration.d.ts` (hash: 70a416c762c5f239ac4fc3d55c190784)
// Runtime types generated with workerd@1.20250813.0 2025-04-17 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		OAUTH_KV: KVNamespace;
		MOCKS: string;
		EPIC_ME_MCP_OBJECT: DurableObjectNamespace<import("../workers/index").EpicMeMCP>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MOCKS">> {}
}
