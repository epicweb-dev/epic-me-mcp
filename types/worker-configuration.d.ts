/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./types/worker-configuration.d.ts` (hash: 6b6f624415303eb1432ddc2bce626c0d)
// Runtime types generated with workerd@1.20250813.0 2025-04-17 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		OAUTH_KV: KVNamespace;
		MOCKS: string;
		EPIC_ME_MCP_OBJECT: DurableObjectNamespace /* EpicMeMCP */;
